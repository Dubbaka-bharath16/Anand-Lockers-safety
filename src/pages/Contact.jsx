...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 mt-16 overflow-x-hidden">
      ...
      <section ref={formRef} className="py-8 md:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            >
              <motion.div variants={itemVariants} className="text-center lg:text-left mb-4 md:mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 md:space-y-6 flex-1">
            ...
            >
              <div className="flex-1">
                ...
                >
                  <h4 className="text-lg font-semibold text-blue-800 mb-3 md:mb-4">Follow Us On</h4>
      ...
      {/* FAQ Section */}
      <section ref={faqRef} className="py-8 md:py-20 bg-gradient-to-br from-blue-50 to-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div
            variants={containerVariants}
            initial="hidden"
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full text-left p-3 md:p-6 flex justify-between items-center transition-colors duration-200"
