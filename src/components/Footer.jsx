...
const Footer = () => {
  ...
  const modalContent = {
    privacy: {
      ...
      content: `
        <div class="space-y-4">
          <p class="text-gray-700 text-base leading-relaxed">At Anand Lockers, we are committed to protecting your privacy and ensuring the security of your personal information.</p>
          ...
          <ul class="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
            ...
            <li>Email addresses for service updates</li>
            <li>Website usage data through cookies</li>
            <li>Locker inquiry and booking information</li>
          </ul>

          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">How We Use Your Information</h3>
          <ul class="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
            <li>To respond to your inquiries and provide locker services</li>
            <li>To send security updates and service notifications</li>
          ...
          <p class="text-gray-700 text-base leading-relaxed mt-6">For any questions about our privacy practices, please contact us at <span class="text-amber-600 font-medium">privacy@anandlockers.com</span></p>
        </div>
      `
    },
    terms: {
      ...
      content: `
        <div class="space-y-4">
          <p class="text-gray-700 text-base leading-relaxed">Welcome to Anand Lockers. By accessing our website and services, you agree to these terms and conditions.</p>
          
          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">Service Agreement</h3>
          <p class="text-gray-700 text-base leading-relaxed">Our locker services are provided with bank-grade security and professional standards. Customers must comply with all security protocols.</p>

          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">User Responsibilities</h3>
          <ul class="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
            <li>Maintain confidentiality of access credentials</li>
            <li>Report any security concerns immediately</li>
            <li>Comply with facility access protocols</li>
            <li>Do not store illegal or hazardous materials</li>
          </ul>

          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">Locker Usage</h3>
          <p class="text-gray-700 text-base leading-relaxed">Locker services are provided for secure storage of personal and business valuables. Proper identification and verification are required for access.</p>

          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">Limitation of Liability</h3>
          <p class="text-gray-700 text-base leading-relaxed">Anand Lockers maintains comprehensive security measures but recommends customers obtain appropriate insurance for high-value items.</p>
    ...
    copyright: {
      ...
      content: `
        <div class="space-y-4">
          <p class="text-gray-700 text-base leading-relaxed">All content on the Anand Lockers website is protected by copyright and other intellectual property laws.</p>
          
          <h3 class="font-bold text-amber-700 text-lg mt-6 mb-3">Copyright Ownership</h3>
          <p class="text-gray-700 text-base leading-relaxed">Unless otherwise stated, Anand Lockers owns the copyright for all content on this website, including:</p>
          <ul class="list-disc list-inside space-y-2 text-gray-700 text-base leading-relaxed">
            <li>Security system information and protocols</li>
            <li>Website design and layout</li>
            <li>Written content and service descriptions</li>
          ...
          <p class="text-gray-700 text-base leading-relaxed">You may view and download content for personal, non-commercial use only. Any other use requires prior written permission from Anand Lockers.</p>
